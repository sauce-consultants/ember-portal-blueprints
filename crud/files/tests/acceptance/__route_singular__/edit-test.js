...
import Page from "<%= appName %>/tests/pages/internal/<%= dasherizedSingular %>/edit";

const PAGE_URL = <%= capitalizedSingular %>_EDIT_URL;

module("Acceptance | <%= routePathSingular %>/edit", function (hooks) {
  setupApplicationTest(hooks);
  setupMirage(hooks);
  setupCustomAssertions(hooks);

  test("Auth: visiting /<%= routePathSingular %>/edit unauthenticated", async function (assert) {
  ...
  test("Auth: visiting /<%= routePathSingular %>/edit", async function (assert) {
    const resource = this.server.create("<%= dasherizedSingular %>"),
  ...
  test("Navigation: back to list view /<%= routePathSingular %>/edit", async function (assert) {
    const resource = this.server.create("<%= dasherizedSingular %>");
  ...
  test("Navigation: load read view /<%= routePathSingular %>/edit", async function (assert) {
    const resource = this.server.create("<%= dasherizedSingular %>"),
      describe = `<%= titleSingular %> ${resource.id}`;
