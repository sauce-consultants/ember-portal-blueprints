...
const Template = (args) => ({
  template: hbs`<Layout::Sidebar as |layout|>

    <layout.Main class="bg-primary-100 dark:bg-primary-900 py-6 px-6 lg:px-12 ">
    ...
    <layout.Side class="bg-accent-100 dark:bg-accent-900 py-6 px-6 lg:px-12 ">
      <div class="prose dark:prose-light">
        <h1>Side Area</h1>
        <p>This is where supplementary content:</p>
        <ul>
          <li>Navigation</li>
          <li>Meta data</li>
          <li>Help text</li>
