import {
  ...
  import { <%= capitalizedSingular %>_<%= manyCapitalizedPlural %>_URL } from "<%= appName %>/tests/helpers/test-urls";
  
  const TEST_SELECTOR_VALUE = '<%= manyDasherizedSingular %>';

  export default create({
    visit: visitable(<%= capitalizedSingular %>_<%= manyCapitalizedPlural %>_URL),
    ...
    actions: {
        ...
        <%= manyCamelPlural %>: {
            click: clickable('[data-test-nav-item="<%= manyDasherizedPlural %>"]'),
            isActive: isPresent('[data-test-nav-item="<%= manyDasherizedPlural %>"][data-test-active]'),
        },
        archive: {
